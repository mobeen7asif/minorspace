<div class="product_header_left">
    <div class="custom_select">
        <select class="form-select form-control-sm" name="sort-by" id="sort-by" data-bb-toggle="product-form-filter-item">
...
<div class="product_header_right">
    ...
    <div class="custom_select">
        <select class="form-select form-control-sm" name="num" data-bb-toggle="product-form-filter-item">
