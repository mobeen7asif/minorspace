                                            ...
                                            <tr>
                                                ...
                                                <td class="product-quantity" data-title="{{ __('Quantity') }}">
                                                    ...
                                                    <div class="quantity">
                                                        ...
                                                        @endif
                                                        <input type="text" value="{{ $isBundleItem ? 1 : $cartItem->qty }}" title="Qty" class="qty" size="4" name="items[{{ $key }}][values][qty]" @if($isBundleItem) readonly style="background: #f5f5f5; pointer-events: none;" @endif>
                                                        @if ($cartBundleHelper->shouldShowQuantityControls($cartItem))
