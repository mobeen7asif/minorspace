...
<li @if ($hasChildren) class="dropdown dropdown-mega-menu" @endif>
    <a class="dropdown-item nav-link @if ($hasChildren) dropdown-toggler @endif" href="{{ route('public.single', $category->url) }}" @if ($hasChildren) data-bs-toggle="dropdown" @endif>
