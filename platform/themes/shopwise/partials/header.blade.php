    ...
    <head>
        ...
        <style>
            :root {
                ...
                --header-menu-text-color: {{ theme_option('header_menu_text_color', '#ffffff') }};
                --header-menu-background-color: {{ theme_option('header_menu_background_color', '#1D2224') }};
            }
        </style>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu language_bar_chooser">
                                                    @foreach ($currencies as $currency)
                                                        <li>
                                                            <a href="{{ route('public.change-currency', $currency->title) }}" @if (get_application_currency_id() == $currency->id) class="active px-3" @else class="px-3" @endif><span>{{ $currency->title }}</span></a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </div>
