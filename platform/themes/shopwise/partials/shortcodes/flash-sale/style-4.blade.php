<div {!! $shortcode->htmlAttributes() !!} class="section background_bg" @if ($shortcode->background_image) data-img-src="{{ RvMedia::getImageUrl($shortcode->background_image) }}" @endif>
	<div class="container">
    	<div class="row">
