<div class="mt-4 staggered-animation-wrap">
	<div class="custom-container">
    	<div class="row">
        	<div class="@if ($collapsingProductCategories) col-lg-7 offset-lg-3 @else col-lg-10 @endif">
            	<div class="banner_section shop_el_slider">
                    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-bs-ride="carousel">
                                        ...
                                        <div class="col-lg-7 col-10">
                                            <div class="banner_content3 overflow-hidden">
                                                @if ($slider->getMetaData('sub_title', true))
                                                    <h5 class="mb-3 staggered-animation fw-light" data-animation="slideInLeft"
                        ...
                        <div class="carousel-indicators indicators_style3">
                            @foreach($sliders as $slider)
                                <button type="button" data-bs-target="#carouselExampleControls" data-bs-slide-to="{{ $loop->index }}" @if ($loop->first) class="active" @endif aria-current="{{ $loop->first ? 'true' : 'false' }}" aria-label="Slide {{ $loop->iteration }}"></button>
                            @endforeach
                        </div>
                    </div>
                </div>
