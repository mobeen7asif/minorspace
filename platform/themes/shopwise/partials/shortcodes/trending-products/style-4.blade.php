...
<!-- START SECTION SHOP -->
<div {!! $shortcode->htmlAttributes() !!} class="section small_pt pb_70">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6">
                <div class="heading_s4 text-{{ $titleAlignment }}">
                    <h2>{!! BaseHelper::clean($shortcode->title) !!}</h2>
                </div>
                <p class="text-{{ $titleAlignment }} leads">{!! BaseHelper::clean($shortcode->description) !!}</p>
            </div>
		</div>
