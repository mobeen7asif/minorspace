...
<div {!! $shortcode->htmlAttributes() !!} class="section small_pt small_pb">
    <div class="container">
        <div class="row">
            ...
            @endif
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{!! $responsiveConfig !!}'>
