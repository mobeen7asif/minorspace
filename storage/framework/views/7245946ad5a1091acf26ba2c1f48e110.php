            ...
            <div class="col-md-12">
                <div class="tab-content">
                    <div class="tab-pane fade show active">
                        <div class="row row-cols-xxl-<?php echo e($itemsPerRow); ?> row-cols-xl-<?php echo e(max(3, $itemsPerRow - 1)); ?> row-cols-lg-<?php echo e(max(2, $itemsPerRow - 2)); ?> row-cols-md-3 row-cols-sm-<?php echo e($itemsPerRowOnMobile); ?> row-cols-<?php echo e($itemsPerRowOnMobile); ?>">
                            <?php for($i = 0; $i < 8; $i++): ?>
                                <div class="col">
...
</div><?php /**PATH C:\www\test.fancyprofile.com\platform\themes/shopwise/partials/shortcodes/product-blocks-skeleton.blade.php ENDPATH**/ ?>