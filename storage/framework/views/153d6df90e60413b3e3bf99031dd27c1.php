...
<div class="section skeleton-flash-sale">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="heading_s1 mb-3 text-center">
                    <div class="skeleton-loading-bg" style="height: 32px; width: 300px; margin: 0 auto 10px; border-radius: 4px;"></div>
                    <div class="skeleton-loading-bg" style="height: 20px; width: 400px; margin: 0 auto; border-radius: 4px;"></div>
                </div>
                <div class="skeleton-timer">
                    <?php for($i = 0; $i < 4; $i++): ?>
                        <div class="skeleton-timer-item skeleton-loading-bg"></div>
                    <?php endfor; ?>
                </div>
            </div>
        </div>
...
</div><?php /**PATH C:\www\test.fancyprofile.com\platform\themes/shopwise/partials/shortcodes/flash-sale-skeleton.blade.php ENDPATH**/ ?>